    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">后台管理-回复管理</h1>
				...
				<TR><th>序号</th><th>标题</th><th>作者</th><th>留言时间</th></TR>
					      <?php 
					       ...
					       $no =1;
					       	while ($row=mysqli_fetch_assoc($result)){    //取出数据表中的数据
					       		...
					       		echo "<TD vAlign=bottom noWrap width='50%'><a href='reply_display.php?id=".$row['id']."'>".$row['title']."</a></TD>";     //从数据库中导出数据并且按着id进行页面跳转
					       	...
					       	echo "<TD colspan=4 >";
					       	$page = new Pages($each_disNums, $nums, $current_page,3, "reply_admin.php?page=", 1);
