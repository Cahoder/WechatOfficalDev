...
$get_send_people = $_GET['sendto'];

 
if (isset($_POST['btn'])){
	send_people_message($_POST['sendto'],$_POST['msg'],$_POST['msg_type']);
}
?>
<!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">您可以对用户发送私信</h1>
                    </div>
                </div>
                <!-- /. 在线回复  -->
                <?php 
                ...
                <form name="LoginForm" action="" method="post" onsubmit="return check()">
                	<tr><p>收信人：<INPUT name="sendto" id="sendto" type="text" size="16" value=<?php echo "'".$get_send_people."'";?>></p></tr>
					<tr>类型：
					<td>
