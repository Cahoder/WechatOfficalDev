...
$get_reply_people = $_GET['sendfrom'];

 
if (isset($_POST['btn'])){
	reply_people_message($_POST['sendto'],$_POST['msg'],$_POST['msg_type']);
}
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">回复消息</h1>
                        <h1 class="page-subhead-line">您可以对来信用户进行回复</h1>
                    </div>
                </div>
                <!-- /. 在线回复  -->
                <?php 
                ...
                <form name="LoginForm" action="" method="post" onsubmit="return check()">
                	<tr><p>收信人：<INPUT name="sendto" id="sendto" type="text" size="16" value=<?php echo "'".$get_reply_people."'";?>></p></tr>
					<tr>类型：
					<td>
					<INPUT name="msg_type" id="ly_type" type="radio" size="16"  value="教育" checked="checked">教育
					<INPUT name="msg_type" id="ly_type" type="radio" size="16"  value="建议">建议
					<INPUT name="msg_type" id="ly_type" type="radio" size="16"  value="求助">求助
					<INPUT name="msg_type" id="ly_type" type="radio" size="16"  value="批评">批评
					<INPUT name="msg_type" id="ly_type" type="radio" size="16"  value="表扬">表扬
					</td>		
					</tr>
					<p>发送内容：</p>
					<script type="text/javascript" src="./ckeditor/ckeditor.js"></script>
					<textarea rows="10" cols="80" id="msg" name="msg" ></textarea>
					<script type="text/javascript">var editor = CKEDITOR.replace('msg');</script>
					<button name="btn"  type="submit" value="" >发送</button> <button name="reset"  value=""  type="reset">重置</button>	
				</form>
