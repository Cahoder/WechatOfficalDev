    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">查看留言</h1>
                ...
                $sqll = "select * from lyb_info where state=0";
                ...
                $sql = "select * from lyb_info where state=0 order by publish_time desc limit ".($current_page-1)*$each_disNums.",".$each_disNums."";   //倒序排序，每页显示3个数据
                ...
                while ($row=mysqli_fetch_assoc($result)){    //取出数据表中的数据
                	...
                	echo "<P align='left' ><span style='font-size:20px; color:black;'>News'".$no++."':<a href='display.php?id=".$row['id']."'>《".$row['title']."》</a></span>"; //从数据库中导出数据并且按着id进行页面跳转
                	echo "<span vAlign=bottom noWrap align='center'>-------<a href='send_person_letter.php?sendto=".$row['author']."' >‘".$row['author']."’</a>于</span>";
                	echo "<span vAlign=bottom noWrap align='center'>".$row['publish_time']."发表</span>";
                	echo "</P>";    
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success">
                           	  <p><?php $page = new Pages($each_disNums, $nums, $current_page,3, "view.php?page=", 1);?></p>
                        </div>
                    </div>
               	 </div>
                 <!--./ 新闻换页  -->
